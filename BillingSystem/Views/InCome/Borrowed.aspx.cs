...
namespace BillingSystem.Views
{
    public partial class Borrowed : System.Web.UI.Page
    {
        ...
        protected void btnBorrowQuerySubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                QueryElement query = new QueryElement { Queryname = "Borrower", QueryElementType = MySqlDbType.String, Queryvalue = this.txtBorrowAddBorrower.Text.Trim(), QueryOperation = "like" };
                queryList.Add(query);
            }
        ...
        private void InitializeBorrowAdd(BorrowInfo borrowInfo)
        {
            if (borrowInfo.Id > 0)
            {
        ...
        protected void RadioBorrowAddLoanType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.RadioBorrowAddLoanType.SelectedValue == "2")
            {
                this.divLoan.Visible = true;
            }
            else
            {
                this.divLoan.Visible = false;
        ...
        protected void RadioBorrowAddBorrowType_SelectedIndexChanged(object sender, EventArgs e)
        {
