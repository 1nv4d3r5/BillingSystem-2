...
CREATE TABLE `borrow` (
  ...
  `BorrowType` int(10) unsigned NOT NULL COMMENT '借款方式：1，现金；2，转账',
  `BorrowAccount` varchar(30) DEFAULT NULL COMMENT '借入账户',
  ...
  `BorrowAmount` float(20,3) NOT NULL COMMENT '借款金额',
  `BorrowDate` datetime NOT NULL COMMENT '借款日期',
